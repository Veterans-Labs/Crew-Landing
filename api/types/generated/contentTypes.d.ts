...
export interface ApiManifiestManifiest extends Struct.CollectionTypeSchema {
  collectionName: 'manifiests';
  info: {
    displayName: 'Manifiest';
    pluralName: 'manifiests';
    singularName: 'manifiest';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::manifiest.manifiest': ApiManifiestManifiest;
